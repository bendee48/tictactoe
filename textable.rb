module Textable
  ...
  def introduction(valid_moves, game)
    puts "Welcome to TictacToe."; sleepy
    puts "The whirlwind extravaganza of...trying to put 3 things in a row."; sleepy
    puts "If you would like to see how to play, enter 'R' or press Return to continue."
    answer = gets.chomp.downcase
    rules(valid_moves, game) if answer == "r"
  end

  def rules(valid_moves, game)
    puts "Players take it in turns to place either a cross or a nought on the board."; sleepy
    puts "Try to get 3 in a row to win."; sleepy
    puts "The board is split into 3 rows of top, middle and bottom."; sleepy
    puts "...and 3 columns of left, middle and right."; sleepy
    puts "Use the first letter's of a row and column to make your move eg. TL (Top Left)"; sleepy
    puts "Enter 'M' to see the full move list, or press Return to continue."
    answer = gets.chomp.downcase
